...
"[project]/app/(platform)/profile/data:a449ba [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$platform$292f$profile$2f$data$3a$a449ba__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/(platform)/profile/data:a449ba [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function ProfileForm({ initialData }) {
    ...
    const handleSubmit = (e)=>{
        ...
        startTransition(async ()=>{
            try {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$platform$292f$profile$2f$data$3a$a449ba__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateProfile"])(formData);
                if (result.error) {
                    setMessage({
                        type: 'error',
                        text: result.error
...
//# sourceMappingURL=_1969a492._.js.map